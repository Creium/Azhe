...
int main(int argc, char *argv[]){
    ...
    trace2.Log(log,DqcTraceEnable::E_DQC_OWD|DqcTraceEnable::E_DQC_BW|DqcTraceEnable::E_DQC_GOODPUT);
    test_pair++;
    ...
    DqcTrace trace3;
    log=prefix+std::to_string(test_pair);
    trace3.Log(log,DqcTraceEnable::E_DQC_OWD|DqcTraceEnable::E_DQC_BW|DqcTraceEnable::E_DQC_GOODPUT);
    test_pair++;
    ...
    DqcTrace trace4;
    log=prefix+std::to_string(test_pair);
    trace4.Log(log,DqcTraceEnable::E_DQC_OWD|DqcTraceEnable::E_DQC_BW|DqcTraceEnable::E_DQC_GOODPUT);
    test_pair++;
    ...
    DqcTrace trace5;
    log=prefix+std::to_string(test_pair);
    trace5.Log(log,DqcTraceEnable::E_DQC_OWD|DqcTraceEnable::E_DQC_BW|DqcTraceEnable::E_DQC_GOODPUT);
    test_pair++;
